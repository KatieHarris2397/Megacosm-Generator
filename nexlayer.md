# Nexlayer — swift-crane-megacosm-generator

**Live:** [https://kitbear-studio-swift-crane-megacosm-generator.cloud.nexlayer.ai](https://kitbear-studio-swift-crane-megacosm-generator.cloud.nexlayer.ai)  

**Runtime:** python · **Port:** 8000 · **Deploy branch:** develop

---

## How this deployment works

**swift-crane-megacosm-generator** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
```yaml
application:
  name: swift-crane-megacosm-generator
  pods:
    - name: app
...
> The container exposes port 8000. When adding a new service (database, cache,
> worker), add it as a new pod in `nexlayer.yaml` and reference it with
> `${podName:port}` syntax. CI/CD runs on push to `develop`."*
